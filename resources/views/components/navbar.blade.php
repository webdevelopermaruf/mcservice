<nav class="container d-flex justify-content-between align-items-center">
    <div class="align-middle mr-10">
        <a class="text-14-medium call-phone hover-up" href="tel:{{json_decode($contacts->long_description)->phone1}}">{{json_decode($contacts->long_description)->phone1}}</a>
        <a class="text-14-medium call-email hover-up ml-5" href="mailto:{{json_decode($contacts->long_description)->email}}">{{json_decode($contacts->long_description)->email}}</a>
    </div>
    <div class="align-middle d-none d-lg-block mr-10">
